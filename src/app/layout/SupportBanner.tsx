...
export function SupportBanner() {
  ...
  return (
    <div className="flex items-center justify-between gap-3 px-4 sm:px-6 py-2 bg-[rgba(22,163,74,0.12)] border-b border-[rgba(22,163,74,0.25)] text-sm text-[var(--color-text-primary)]">
      ...
      <button
        ...
        disabled={returning}
        className="shrink-0 inline-flex items-center gap-1.5 rounded-lg border border-[rgba(22,163,74,0.35)] px-3 py-1.5 text-xs font-semibold text-[var(--color-text-primary)] transition hover:border-[var(--accent-primary)] hover:bg-[rgba(22,163,74,0.06)] disabled:opacity-50"
      >
