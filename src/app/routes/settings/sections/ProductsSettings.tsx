...
const selectCls =
  'h-11 w-full rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-4 text-sm text-[var(--color-text-primary)]';
        ...
        <form onSubmit={handleCreate} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              disabled={saving}
              className="w-full resize-none rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-4 py-2.5 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--accent-primary)]"
            />
          </div>
        </form>
      </Card>
                ...
                editingId === p.id ? (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      disabled={editSaving}
                      className="w-full resize-none rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-3 py-2 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--accent-primary)]"
                    />
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="rounded-full bg-[rgba(22,163,74,0.06)] px-2 py-0.5 text-[10px] text-[var(--color-text-secondary)]">
