      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2 relative">
          ...
          <textarea
            ...
            rows={12}
            disabled={saving}
            className="w-full rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-4 py-3 text-sm text-[var(--color-text-primary)] font-mono placeholder:text-[var(--color-text-secondary)] focus:outline-none focus:border-[var(--accent-primary)] focus:bg-[rgba(22,163,74,0.10)]"
          />
          {varMenu && menuMatches.length > 0 && (
            <div className="absolute z-20 mt-1 w-64 rounded-lg border border-[rgba(22,163,74,0.25)] bg-white shadow-2xl overflow-hidden">
              {menuMatches.map((k) => (
                <button
                  key={k}
                  type="button"
                  ...
                  className="block w-full text-left px-3 py-2 text-sm font-mono text-[var(--color-text-primary)] hover:bg-[rgba(22,163,74,0.12)]"
                >
                  {`{${k}}`}
                </button>
              ))}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 max-w-2xl">
            <label className="flex items-center gap-3 h-11 px-4 rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] cursor-pointer">
              <input
                type="checkbox"
        ...
        <div className="space-y-2">
          <Label>Funil</Label>
          <label className="flex items-center gap-3 min-h-11 px-4 py-2 rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] cursor-pointer max-w-2xl">
            <input
              type="checkbox"
        ...
        <div className="rounded-xl border border-[rgba(22,163,74,0.12)] bg-[rgba(22,163,74,0.05)]">
          <button
            type="button"
          ...
          {advancedOpen && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 border-t border-[rgba(22,163,74,0.1)] p-5">
