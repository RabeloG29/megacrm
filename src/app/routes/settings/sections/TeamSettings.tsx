      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          {loading ? (
            ...
            <ul className="divide-y divide-[rgba(22,163,74,0.08)] rounded-lg border border-[rgba(22,163,74,0.1)] bg-[rgba(22,163,74,0.05)]">
              {members.map((m) => (
                <li
                  key={m.id}
    ...
    <Card>
      <div className="space-y-5">
        <header className="flex items-start justify-between gap-3">
          ...
          <label className="flex shrink-0 cursor-pointer select-none items-center gap-2 rounded-lg border border-[rgba(22,163,74,0.25)] px-3 py-2 text-sm text-[var(--color-text-primary)] transition hover:border-[var(--accent-primary)]">
            <input
              type="checkbox"
              checked={enabled}
            ...
            <ul className="space-y-1.5">
              {queue.map((m, i) => (
                <li
                  ...
                  onDrop={() => onDrop(i)}
                  className="flex items-center justify-between gap-3 rounded-lg border border-[rgba(22,163,74,0.15)] bg-[rgba(22,163,74,0.05)] px-3 py-2"
                >
                  ...
                  <span
                    className="ml-auto shrink-0 rounded-full bg-[rgba(22,163,74,0.1)] px-2.5 py-0.5 text-[11px] font-semibold text-[var(--accent-secondary)]"
