        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="text-label border-b border-[rgba(22,163,74,0.12)]">
              ...
              <tbody className="divide-y divide-[rgba(22,163,74,0.08)]">
                {orgs.map((org) => (
    ...
    <span
      className={
        active
          ...
          : 'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold bg-[rgba(22,163,74,0.06)] text-[var(--color-text-secondary)]'
      }
    >
...
function IconAction({
  ...
  return (
    <button
      ...
      aria-label={label}
      title={label}
      className="flex h-8 w-8 items-center justify-center rounded-lg text-[var(--color-text-secondary)] transition hover:bg-[rgba(22,163,74,0.06)] hover:text-[var(--color-text-primary)] disabled:opacity-40 disabled:hover:bg-transparent"
    >
      {icon}
    </button>
  );
