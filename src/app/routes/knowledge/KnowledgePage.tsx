        ...
        <div className="md:hidden space-y-2">
          {loading ? (
            ...
            items.map((it) => {
              ...
              return (
                <div key={it.id} className="rounded-lg border border-[rgba(22,163,74,0.1)] bg-[rgba(22,163,74,0.05)] p-3">
            ...
            <tbody>
              {loading ? (
                ...
                items.map((it) => {
                  const Icon = it.type === 'url' ? Globe : FileText;
                  return (
                    <tr key={it.id} className="border-t border-[rgba(22,163,74,0.06)]">
                      <td className="p-3">
      ...
      <form onSubmit={handle} className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            {([
              ...
              <button
                ...
                className={
                  sourceType === id
                    ? 'p-3 rounded-lg border border-[var(--accent-primary)] bg-[rgba(22,163,74,0.08)] text-sm'
                    : 'p-3 rounded-lg border border-[rgba(22,163,74,0.12)] bg-[rgba(22,163,74,0.05)] text-sm text-[var(--color-text-secondary)]'
                }
                disabled={submitting}
              >
        ...
        {sourceType === 'text' && (
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-4 py-3 text-sm text-[var(--color-text-primary)] focus:outline-none focus:border-[var(--accent-primary)]"
            />
          </div>
        )}
        ...
        {sourceType === 'pdf' && (
          <div className="space-y-2">
            ...
            <label
              htmlFor="kb_file"
              className="flex items-center gap-3 h-11 px-4 rounded-lg border border-dashed border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] cursor-pointer hover:border-[rgba(22,163,74,0.4)]"
            >
