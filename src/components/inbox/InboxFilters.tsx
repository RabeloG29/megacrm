...
const inputCls =
  'w-full rounded-md border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-2 py-1.5 text-sm text-[var(--color-text-primary)] outline-none focus:border-[var(--accent-primary)]';
const labelCls =
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? 'border-[var(--accent-primary)] bg-[rgba(22,163,74,0.15)] text-[var(--color-text-primary)]'
          : 'border-[rgba(22,163,74,0.15)] text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)] hover:border-[rgba(22,163,74,0.35)]',
      )}
    >
      {children}
    </button>
...
function MultiSelect({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-[60] mt-1 max-h-56 w-full overflow-y-auto rounded-lg border border-[rgba(22,163,74,0.25)] bg-[#F3FBF6] p-1 shadow-[0_0_30px_rgba(22,163,74,0.15)]">
          {options.length === 0 && (
          ...
          {options.map((o) => (
            <label
              key={o.id}
              className="flex cursor-pointer items-center gap-2 rounded-md px-2 py-1.5 text-sm text-[var(--color-text-primary)] hover:bg-[rgba(22,163,74,0.06)]"
            >
              <input
                type="checkbox"
    ...
    <div className="p-4">
      <div className="mb-3 flex items-center justify-between sm:hidden">
        ...
        <button
          ...
          className="h-9 w-9 flex items-center justify-center rounded-lg text-[var(--color-text-secondary)] hover:bg-[rgba(22,163,74,0.06)]"
        >
      ...
      {count > 0 && (
        <div className="mt-3 flex justify-end">
          <button
            ...
            className="inline-flex items-center gap-1 rounded-md border border-[rgba(22,163,74,0.2)] px-2.5 py-1.5 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)] hover:text-[var(--color-text-primary)]"
          >
    ...
    <div className="flex items-center gap-2" ref={rootRef}>
      <button
        ...
        className={cn(
          ...
          count > 0
            ? 'border-[var(--accent-primary)] bg-[rgba(22,163,74,0.12)] text-[var(--color-text-primary)]'
            : 'border-[rgba(22,163,74,0.2)] text-[var(--color-text-secondary)] hover:text-[var(--color-text-primary)]',
        )}
      >
      ...
      <label className="inline-flex items-center gap-1.5 rounded-lg border border-[rgba(22,163,74,0.2)] px-2.5 py-2 text-xs text-[var(--color-text-secondary)] transition hover:border-[var(--accent-primary)]">
        <ArrowUpDown className="h-3.5 w-3.5 opacity-70" />
        <select
          value={sort}
          onChange={(e) => onSortChange(e.target.value as InboxSort)}
          className="bg-transparent text-xs text-[var(--color-text-primary)] outline-none [&>option]:bg-[#F3FBF6]"
        >
        ...
        createPortal(
          <>
            ...
            <div
              ...
              className={cn(
                'z-50 bg-white border border-[rgba(22,163,74,0.25)] shadow-[0_0_40px_rgba(0,0,0,0.15)]',
