          ...
          <li key={c.id}>
            <button
              ...
              className={cn(
                ...
                locked ? 'opacity-50 cursor-not-allowed' : 'hover:bg-[rgba(22,163,74,0.06)]',
                isActive && !locked && 'bg-[rgba(22,163,74,0.08)] border-l-2 border-[var(--accent-primary)]',
            ...
            >
              <div className="flex items-start gap-3">
                <div className="relative shrink-0">
                  ...
                  <span
                    title={chan.label}
                    className="absolute -bottom-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-[#F3FBF6] ring-1 ring-[rgba(22,163,74,0.2)]"
                  >
