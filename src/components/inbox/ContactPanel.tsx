    ...
    <div className="h-full p-5 space-y-5 overflow-y-auto">
      <div className="text-center">
        <Avatar
          ...
          name={displayName}
          size="lg"
          className="mx-auto shadow-[0_0_30px_rgba(22,163,74,0.25)]"
        />
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="h-11 w-full rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-3 text-sm text-[var(--color-text-primary)]"
        >
          ...
          {lostReasonOpen && (
            <div className="space-y-2 rounded-lg border border-[rgba(239,68,68,0.2)] bg-[rgba(239,68,68,0.05)] p-3">
              <input
                ...
                className="h-11 w-full rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-3 text-sm text-[var(--color-text-primary)] focus:outline-none focus:border-[var(--accent-primary)]"
                autoFocus
              />
              <button
      ...
      <div className="pt-3 border-t border-[rgba(22,163,74,0.08)] text-[10px] text-[var(--color-text-secondary)] opacity-70 space-y-0.5">
