            ...
            return (
              <li
                ...
                className={`rounded-lg border p-3 ${
                  i === 0
                    ? 'border-[rgba(22,163,74,0.4)] bg-[rgba(22,163,74,0.06)]'
                ...
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-1.5">
                      ...
                      <span className="rounded-full bg-[rgba(22,163,74,0.06)] px-2 py-0.5 text-[10px] font-semibold text-[var(--color-text-secondary)]">
