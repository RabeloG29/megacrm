...
export function NotificationsDropdown() {
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-[360px] max-w-[calc(100vw-1.5rem)] rounded-xl border border-[rgba(22,163,74,0.25)] bg-white shadow-2xl z-50 overflow-hidden max-h-[70vh] flex flex-col">
          <div className="flex items-center justify-between p-3 border-b border-[rgba(22,163,74,0.1)]">
            <div>
          ...
          <div className="flex-1 overflow-y-auto">
            {notifications.length === 0 ? (
              ...
              <ul className="divide-y divide-[rgba(22,163,74,0.06)]">
                {notifications.map((n) => {
                    ...
                    <li key={n.id}>
                      <button
                        ...
                        className={cn(
                          ...
                          !n.is_read && 'bg-[rgba(22,163,74,0.04)]',
                        )}
                      >
                        <div
                          className={cn(
                            ...
                            n.type === 'handoff'
                              ...
                              : 'bg-[rgba(22,163,74,0.15)] text-[var(--accent-primary)]',
                          )}
                        >
