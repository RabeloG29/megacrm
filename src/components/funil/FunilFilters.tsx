...
function MultiSelect({
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute z-30 mt-1 max-h-56 w-full overflow-y-auto rounded-lg border border-[rgba(22,163,74,0.25)] bg-[#F3FBF6] p-1 shadow-[0_0_30px_rgba(22,163,74,0.15)]">
          {options.length === 0 && (
            <div className="px-2 py-1.5 text-xs text-[var(--color-text-secondary)]">Nenhuma opção</div>
          )}
          {options.map((o) => (
            <label key={o.id} className="flex cursor-pointer items-center gap-2 rounded-md px-2 py-1.5 text-sm text-[var(--color-text-primary)] hover:bg-[rgba(22,163,74,0.06)]">
