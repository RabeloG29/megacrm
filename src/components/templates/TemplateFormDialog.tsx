      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="rounded-lg border border-[rgba(139,92,246,0.25)] bg-[rgba(139,92,246,0.05)] p-4 space-y-3">
          ...
          <textarea
            ...
            rows={2}
            className="w-full rounded-lg border border-[rgba(139,92,246,0.2)] bg-[rgba(22,163,74,0.06)] px-4 py-2 text-sm text-[var(--color-text-primary)] focus:outline-none focus:border-[#A78BFA]"
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            rows={5}
            disabled={saving}
            className="w-full rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-4 py-3 text-sm font-mono text-[var(--color-text-primary)] focus:outline-none focus:border-[var(--accent-primary)]"
          />
          <div className="flex items-center justify-between gap-2">
            ...
            <button
              ...
              disabled={saving}
              className="shrink-0 rounded-md border border-[rgba(22,163,74,0.25)] px-2 py-1 text-[11px] text-[var(--accent-secondary)] transition hover:border-[var(--accent-primary)]"
            >
              + Variável
            </button>
          </div>
        ...
        {detectedVars.length > 0 && (
          <div className="space-y-2 rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.05)] p-3">
