    ...
    <Dialog open={open} onClose={onClose} title="Nova campanha" widthClass="max-w-3xl" opaque>
      ...
      {step === 0 && (
        <div className="space-y-4">
          ...
          {selectedTemplate && (
            <div className="rounded-lg border border-[rgba(22,163,74,0.1)] bg-[rgba(22,163,74,0.05)] p-3 text-xs font-mono text-[var(--color-text-secondary)] whitespace-pre-wrap">
              {selectedTemplate.body}
            </div>
          )}

          {varCount > 0 && (
            <div className="space-y-3 rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.05)] p-3">
                ...
                return (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      disabled={submitting}
                      className="h-9 w-52 shrink-0 rounded-lg border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.06)] px-2 text-xs text-[var(--color-text-primary)]"
                    >
