...
export function TemplatesList() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-start gap-2 rounded-lg border border-[rgba(22,163,74,0.15)] bg-[rgba(22,163,74,0.05)] px-4 py-3 text-sm text-[var(--color-text-secondary)]">
      ...
      <div className="glass-card p-4">
        <div className="rounded-lg border border-[rgba(22,163,74,0.08)] overflow-x-auto">
