              ...
              <div className="flex flex-wrap items-center gap-2">
                {[
                  ...
                  .map(([label, v]) => (
                    <span
                      key={label}
                      className="rounded-full border border-[rgba(22,163,74,0.2)] bg-[rgba(22,163,74,0.05)] px-3 py-1 text-[11px] text-[var(--color-text-secondary)]"
                    >
            ...
            {loading ? (
              ...
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={volumeByDay} margin={{ top: 4, right: 10, left: -20, bottom: 0 }}>
                  <CartesianGrid stroke="rgba(22,163,74,0.08)" vertical={false} />
                  <XAxis
                    dataKey="day"
                    tick={{ fontSize: 11, fill: '#5B7566' }}
                    tickFormatter={(d) => (typeof d === 'string' ? d.slice(5) : '')}
                    stroke="rgba(22,163,74,0.2)"
                  />
                  <YAxis tick={{ fontSize: 11, fill: '#5B7566' }} stroke="rgba(22,163,74,0.2)" allowDecimals={false} />
                  <Tooltip
                    contentStyle={{
